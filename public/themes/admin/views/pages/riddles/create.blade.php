                            ...
                            <div class="box box-primary">
                                ...
                                {{ Form::token() }}
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3 {{ setClassHasError($errors->has('type')) }}">
                                            ...
                                            <div class="form-group col-md-3 col-md-offset-3 {{ setClassHasError($errors->has('publish_status')) }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-0 {{ setClassHasError($errors->has('question')) }}">
